...
loan_info_row_rdd = loan_info_row.map(lambda attributes: Row(attributes[5], float(eval(attributes[7]))))
...
# 写入数据库
result_df.write.jdbc("jdbc:mysql://master:3306/huadee?useSSL=false&useUnicode=true&characterEncoding=utf8", 'Rq2',
                     'append', conn_param)
